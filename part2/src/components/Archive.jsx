...
const Persons = ({ people, filter, messageHandler }) => {
    ...
    const handleDeletePerson = (id, name) => {
        const deleteResponse = PhonebookService.deleteNumber(id, name, messageHandler)
    ...
    return (
        <>{peopleList.filter(person =>
            ...
            .map(person =>
                <div key={person.name}>
                    {person.name} {person.number}, it is {person.number?.length % 2 == 1 ? "odd" : "even"}
    ...
    return (
        <div>
            ...
            <PersonForm
                ...
                handlePhoneNumberChange={handlePhoneNumberChange} />
            <h3>Numbers</h3>
            <Persons people={persons} filter={filter} messageHandler={messageHandler} />
        </div>
    )
}
